...
app.directive('pxGrid', ['$timeout', function(timer) {
    return {
        ...
        replace: true,
        transclude: false,
        templateUrl: phoenixPackage() + 'px/system/view/grid.html',
        scope: {
            debug: '@pxDebug',
            table: '@pxTable',
            fields: '@pxFields',
        ...
        controller: function($scope, $element, $attrs, $http) {
            ...
            $scope.pxGridGetData = function() {
                ...
                $('#pxTable').dataTable({
                    ...
                    "lengthMenu": [10, 25, 45],
                    "bProcessing": true,
                    //"sAjaxSource": "phoenix research/dataTables/data/exemplo.json",
                    /*
                    "aoColumns": [{
                        "mData": "exe_id"
                    }, {
            ...
            $scope.getData = function(rowFrom, rowTo) {
                ...
                $http({
                    method: 'POST',
                    url: phoenixPackage() + 'px/system/model/grid.cfc?method=getData',
                    params: params
